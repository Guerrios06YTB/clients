...
function OpenCloakroomMenu()
  ...
  ESX.UI.Menu.CloseAll()
	...
	ESX.UI.Menu.Open(
		'default', GetCurrentResourceName(), 'Vestiaires',
		{
			title    = _U('Vestiaires'),
			elements = {
				{label = _U('mafia_wear'), value = 'mafia_wear'},
...
function OpenArmoryMenu(station)
  ...
  if Config.EnableArmoryManagement then
    ...
    local elements = {
      {label = _U('get_weapon'), value = 'prendre_arme'},
      {label = _U('put_weapon'), value = 'déposer_arme'},
      {label = 'Prendre Objet',  value = 'prendre_objet'},
      {label = 'Déposer objet',  value = 'déposer_objet'}
    }
